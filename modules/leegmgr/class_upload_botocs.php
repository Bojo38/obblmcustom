...
class UPLOAD_BOTOCS implements ModuleInterface
{
	...
	global $db_prefix;
        ...
        {
            $this->error = "Vous devez être le propriétaire d'une des deux équipes pour pouvoir charger le fichier rapport.";
            return false;
        }
        ...
        {
            $this->error = "Une des équipes n'a pas été trouvée sur le site.";
            return false;
        }
    ...
    function parse_results() {
        ...
        {
            $this->error = "Les rapports BOTOCS ne sont pas autorisés dans cette ligue.";
            return false;
        }
    ...
    function parse_cy_results() {
        ...
        {
            $this->error = "Les rapport Cyanides nesont pas autorisés dans cette ligue.";
            return false;
        }
    ...
    function addMatch () {
        ...
        {
            $this->error = "Une des équipes a un autre match de programmé.";
            return false;
        }
...
global $db_prefix;
    ...
    function valXML() {
        ...
        if (!$xml->schemaValidate($xsdfile)) {
            ...
            $this->error .= " -->";
            $this->error .= "<br><br>La cause la plus probable d'erreur est un template de match erroné.
                            SVP, téléchargez le template approprié et regénérez le rapport.";
            return false;
        }
    ...
    function processFile() {
            ...
            {
                $this->error = "Choisissez un fichier à charger";
                return false;
            }
