...
<table>
    <tr>
        <td class="indtitle">Nom du Champion</td>
        <td class="indtitle">Prix</td>
        <td class="indtitle">M</td>
        <td class="indtitle">F</td>
        <td class="indtitle">Ag</td>
        <td class="indtitle">Ar</td>
        <td class="indtitle">Compétences</td> <!-- <td>Cp</td><td>Td</td><td>Int</td><td>Cas</td><td>BH</td><td>Si</td><td>Ki</td><td>MVP</td><td>SPP</td> -->
    </tr>
<?php
...
<table>
    <tr>
        <td class="indtitle">Mercenaire</td>
        ...
        <td class="indtitle">Ag</td>
        <td class="indtitle">Ar</td>
        <td class="indtitle">Compétences</td>
        <td class="indtitle">Compétence supplémentaire</td>
    </tr>
<?php
...
while (isset($_POST["Merc$i"])) {
  ...
  if ($_POST["Merc$i"] != '0') {
    ...
    if (isset($_POST["Extra$i"])) {
      $extra_skill_cost = ($_POST["Extra$i"] == '-Pas de compétence supplémentaire-') ? 0 : MERC_EXTRA_SKILL_COST;
    ...
    $extra_list[$i] = "            <option>-Pas de compétence supplémentaire-</option>\n";
...
<table>
    <tr>
        <td class="indtitle">Prime de match</td>
        <td class="indtitle">#</td>
        <td class="indtitle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td class="indtitle">Prix</td>
        <td class="indtitle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td class="indtitle">Prix total</td>
    </tr>
<?php
...
if (($r == 'Pourris de Nurgle') || ($r == 'Khemri') || ($r == 'Necromantiques') || ($r == 'Morts-vivants')) unset($inducements['Apothicaire local']);
...
?>
<tr>
<td class="right" colspan="6"><br><input type="submit" name="Submit" value="Créer le PDF" onclick="return SendToPDF();"></td></tr>
<tr><td><a href="<?php echo urlcompile(T_URL_PROFILE,T_OBJ_TEAM,$team_id,false,false); ?>"> <- Retour à la page d'équipe</a></td></tr>
</table>
</td><td class="cent2">
<table>
<?php
...
echo '<tr><td class="indtitle">Valeur d\'équipe:</td><td class="indtitle">'.kilo($t->value).'k</td></tr>';
echo '<tr><td class="indtitle">Valeur des primes de match:</td><td class="indtitle">'.kilo($ind_cost).'k</td></tr>';
echo '<tr><td class="indtitle">Valeur pour le match:</td><td class="indtitle">'.kilo($ind_cost + $t->value).'k</td></tr>';
?>
