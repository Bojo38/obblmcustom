...
$settings['welcome']     = 'Bienvenue sur le module RAW';
...
$settings['fp_leaders'] = array(
    ...
    array(
        'id'     => 26,
        'box_ID' => 3,
        'title'  => 'RAW: Meilleur destructeur',  
        'field'  => 'cas',
        'length' => 5,
    ),
...
$settings['fp_latestgames'] = array(
	array(
        ...
        'title'  => 'Matchs r&eacute;cents de la ligue RAW',
        'length' => 5,
    ),
);
