...
public static function getModuleUpgradeSQL()
{
    ...
    return array(
        '075-080' => array(
            ...
            'INSERT INTO '.$db_prefix.'log (cid, category, date, msg) SELECT f_id, \'1\', date, txt FROM '.$db_prefix.'texts WHERE type = 10 ORDER BY date ASC',
            'DELETE FROM '.$db_prefix.'texts WHERE type = 10',
        ),
    );
}
...
{
    return mysql_query("INSERT INTO ".$db_prefix."log (date, cid, category, msg) VALUES (NOW(), $cid, $cat, '".mysql_real_escape_string($msg)."')");
}

public static function logViewPage()
{
    global $coach, $lng,$db_prefix;
    ...
    $query = "SELECT * FROM ".$db_prefix."log WHERE date > SUBDATE(NOW(), INTERVAL ".LOG_HIST_LENGTH." MONTH) ORDER BY date DESC";
